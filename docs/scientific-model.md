...
**Status:** working specification for the post-v0.3.2 scientific-hardening line / current model semantics v25 (immutable v0.3.2 release baseline: v19)
