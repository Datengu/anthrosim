...
**Current framework line:** software version `v0.3.6` / current model semantics v41. Immutable `v0.3.6` remains the v35 Scientific-Audit-v6 discovery/release baseline; immutable `v0.3.5` remains the v33 Audit-v5 discovery/release baseline; immutable `v0.3.4` remains the historical v25 Audit-v4 target. Living v39 retains the v36 same-day M9/M4 scheduler repair, the v37 scarce-resource symmetry repair, the v38 reachable-component M9 destination-coupling repair, and the v39 male-parent age-time repair without rewriting any immutable release or audit target.
