...
| Latest protected-main closure baseline examined | `d00b603a134a6b7d920fa7a2a9783a9604effff2` |
...
| Current P2 findings | #314, #315, #320, #327, #329, #332, #336, #342 |
...
The v2 audit originally completed A–N coverage on model semantics v19. Repair of #326 intentionally advanced authoritative causal semantics to v20. Repair of #324 then advanced authoritative household-assignment semantics to v21; subsequent inference/provenance contracts remain explicitly versioned.
...
1. Triage/repair the remaining P2 findings #314, #315, #320, #327, #329, #332, #336 and #342.
...
Audit v2 remains **coverage-complete but not yet backlog-closed**. No P0 finding is open. All P1 findings discovered so far are repaired and independently reverified. The highest-impact remaining P2 household finding #324 is also repaired/reverified on the v21 line, including fresh structural and confirmatory stochastic evidence.

The remaining work is now P2/P3 scientific robustness, interpretation, documentation, initialization, sensitivity, metric semantics and continuation-observability cleanup. #324 is closed; the next issue should be selected from the remaining P2 backlog only after checking live overlap and dependencies.
