...
Read the protocol, charter and this ledger; verify live `main`, immutable `v0.3.3`, open issues/PRs and overlapping work. Do not duplicate Area G while PR #408 remains active. Reconcile newer Area-I work before touching I. With Area J complete, the next non-overlapping pending surface is **Area K — experiment orchestration, configuration, provenance and reproducibility**, unless another agent has taken it. Treat AV3-001 through AV3-013 as known cross-cutting limitations and repair none of them. Do not begin site empirical work, release work, or unrelated development.