...
**This living source tree carries AnthroSim software version `0.3.6` at current model semantics v38.** The immutable `v0.3.6` release remains the Scientific Audit-v6 discovery baseline at model semantics v35; living v37 contains post-discovery Audit-v6 remediation through the AV6-004 scarce-resource symmetry repair. The immutable `v0.3.5` release remains model semantics v33 and is the frozen Audit-v5 discovery target; immutable `v0.3.4` remains model semantics v25 and the historical Audit-v4 target; immutable `v0.3.3` remains model semantics v21. See [`docs/release-versioning.md`](docs/release-versioning.md) for the release/source/semantics distinction.
