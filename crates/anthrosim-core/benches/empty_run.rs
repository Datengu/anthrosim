...
fn resource_migration_demographic_run(c: &mut Criterion) {
    c.bench_function("m4_10k_people_25_year_resource_migration_demography_run", |b| {
        b.iter(|| {
...
criterion_group!(benches, resource_migration_demographic_run);
