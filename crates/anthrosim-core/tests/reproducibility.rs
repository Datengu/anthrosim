...
#[test]
fn identical_runs_emit_identical_resource_migration_demographic_trajectories() {
    ...
    assert_eq!(a.migration.digest64, b.migration.digest64);
    assert_eq!(
...
#[test]
fn different_seeds_change_world_resource_migration_and_population_trajectory() {
    ...
    assert_ne!(a.migration.digest64, b.migration.digest64);
