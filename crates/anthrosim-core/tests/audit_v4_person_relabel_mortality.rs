...
#[test]
fn same_seed_mortality_is_invariant_to_pure_founder_person_relabelling() {
    ...
    assert!(informative_seeds > 0, "adversary did not exercise asymmetric mortality outcomes");
}
